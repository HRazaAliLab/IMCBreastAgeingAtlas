...
# Ki67 negative only
cellsclin <- cellsclin[isKi67Pos == FALSE]
...
ggsave(file.path(outdir, "cellAreaAgeEffectSizesNoKi67.pdf"),
       plot = combined, width = 5, height = 6, units = "in")

#Create a table with the number of patients used in each comparison
...
# fwrite(
#   n_table,
#   file = file.path(outdir, "ExtFig5eCellArea_EffectSizes_noKi67_n_byPhenotype.csv")
# )
